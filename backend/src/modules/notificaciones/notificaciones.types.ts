...
/**
 * Datos de entrada para notificación de cita creada
 */
export interface InputCitaCreada extends NotificacionBase {
...
/**
 * Datos de entrada para notificación de cita confirmada
 */
export interface InputCitaConfirmada extends NotificacionBase {
  numeroConfirmacion: string;
  nombreTrabajadora: string;
  fecha: Date;
  servicios: ServicioNotificacion[];
...
/**
 * Datos de entrada para notificación de cita cancelada
 */
export interface InputCitaCancelada extends NotificacionBase {
  numeroConfirmacion: string;
  nombreTrabajadora: string;
  fecha: Date;
  servicios: ServicioNotificacion[];
